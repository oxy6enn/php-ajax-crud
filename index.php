...
<body>
  ...
  <nav class="navbar justify-content-center fs-3 mb-3" style="background-color:;">PHP Ajax CRUD Application</nav>
  ...
  <div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <!-- Add new user -->
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalAddUser" > <i class="fa-solid fa-user-plus fa-xs"></i>
  Add new user
</button>
    </div>
...
<div class="modal fade" id="modalAddUser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="offcanvasExampleLabel">Add New User</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" id="insertBtn">Save changes</button>
      </div>
      </form>
    </div>
  </div>
  ...
  <!-- Edit user modal -->
<div class="modal fade"  tabindex="-1" aria-labelledby="exampleModalLabel" id="modalEditUser" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="offcanvasExampleLabel">Edit User</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
